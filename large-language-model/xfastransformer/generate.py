...
parser.add_argument("--token_path", type=str,
                    default="/home/sdp/models/Llama-2-7b-hf", help="Path to token file")
parser.add_argument("--model_path", type=str,
                    default="/data/chatglm-6b-cpu", help="Path to model file")
...
if __name__ == "__main__":
    ...
    import automodel_perf
    model = automodel_perf.AutoModel.from_pretrained(
        args.model_path, dtype=args.dtype)
