...
class Client(Iface):
    ...
    def TextFilter(self, req_id, text, carrier):
        ...
        return self.recv_TextFilter()

    def send_TextFilter(self, req_id, text, carrier):
        self._oprot.writeMessageBegin('TextFilter', TMessageType.CALL, self._seqid)
        args = TextFilter_args()
        args.req_id = req_id
        args.text = text
    ...
    def recv_TextFilter(self):
        ...
        if result.se is not None:
            raise result.se
        raise TApplicationException(TApplicationException.MISSING_RESULT, "TextFilter failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["TextFilter"] = Processor.process_TextFilter
    ...
    def process_TextFilter(self, seqid, iprot, oprot):
        args = TextFilter_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = TextFilter_result()
        try:
            result.success = self._handler.TextFilter(args.req_id, args.text, args.carrier)
        ...
        oprot.writeMessageBegin("TextFilter", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
all_structs.append(TextFilter_args)
TextFilter_args.thrift_spec = (
    None,  # 0
...
class TextFilter_result(object):
    """
    Attributes:
     - success
     - se
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(TextFilter_result)
TextFilter_result.thrift_spec = (
