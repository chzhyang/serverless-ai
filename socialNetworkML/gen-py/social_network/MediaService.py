...
class Iface(object):
    def ComposeMedia(self, req_id, media_ids, media_types, media_data_list, carrier):
        """
        Parameters:
         - req_id
         - media_ids
...
class Client(Iface):
    ...
    def send_ComposeMedia(self, req_id, media_ids, media_types, media_data_list, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposeMedia(self, seqid, iprot, oprot):
        ...
        result = ComposeMedia_result()
        try:
            result.success = self._handler.ComposeMedia(args.req_id, args.media_ids, args.media_types, args.media_data_list, args.carrier)
...
class ComposeMedia_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i394 in range(_size390):
                        ...
                        self.media_ids.append(_elem395)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i400 in range(_size396):
                        ...
                        self.media_types.append(_elem401)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i406 in range(_size402):
                        ...
                        self.media_data_list.append(_elem407)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i412 in range(_size408):
                        ...
                        _val414 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.media_types is not None:
            ...
            for iter416 in self.media_types:
        ...
        if self.media_data_list is not None:
            ...
            for iter417 in self.media_data_list:
        ...
        if self.carrier is not None:
            ...
            for kiter418, viter419 in self.carrier.items():
