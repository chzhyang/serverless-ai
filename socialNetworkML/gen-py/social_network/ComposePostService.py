...
class Iface(object):
    def ComposePost(self, req_id, username, user_id, text, media_ids, media_types, media_data_list, post_type, carrier):
        """
        Parameters:
         - req_id
         - username
...
class Client(Iface):
    ...
    def send_ComposePost(self, req_id, username, user_id, text, media_ids, media_types, media_data_list, post_type, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposePost(self, seqid, iprot, oprot):
        ...
        result = ComposePost_result()
        try:
            self._handler.ComposePost(args.req_id, args.username, args.user_id, args.text, args.media_ids, args.media_types, args.media_data_list, args.post_type, args.carrier)
...
class ComposePost_args(object):
    ...
    def __init__(self, req_id=None, username=None, user_id=None, text=None, media_ids=None, media_types=None, media_data_list=None, post_type=None, carrier=None,):
        self.req_id = req_id
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i120 in range(_size116):
                        ...
                        self.media_ids.append(_elem121)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i126 in range(_size122):
                        ...
                        self.media_types.append(_elem127)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i132 in range(_size128):
                        ...
                        self.media_data_list.append(_elem133)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.media_types is not None:
            ...
            for iter142 in self.media_types:
        ...
        if self.media_data_list is not None:
            ...
            for iter143 in self.media_data_list:
...
ComposePost_args.thrift_spec = (
    ...
    (7, TType.LIST, 'media_data_list', (TType.STRING, 'UTF8', False), None, ),  # 7
