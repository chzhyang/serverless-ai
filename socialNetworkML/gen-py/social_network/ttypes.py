...
class Media(object):
    ...
    def __init__(self, media_id=None, media_type=None, media_data=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.media_data = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.media_type is not None:
            ...
            oprot.writeFieldEnd()
        if self.media_data is not None:
            oprot.writeFieldBegin('media_data', TType.STRING, 3)
            oprot.writeString(self.media_data.encode('utf-8') if sys.version_info[0] == 2 else self.media_data)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
Media.thrift_spec = (
    ...
    (3, TType.STRING, 'media_data', 'UTF8', None, ),  # 3
)
