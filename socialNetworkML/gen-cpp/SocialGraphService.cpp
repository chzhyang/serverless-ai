...
uint32_t SocialGraphService_GetFollowers_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("carrier", ::apache::thrift::protocol::T_MAP, 3);
  {
    ...
    for (_iter278 = this->carrier.begin(); _iter278 != this->carrier.end(); ++_iter278)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readI64(this->success[_i284]);
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i324 = 0; _i324 < _size320; ++_i324)
            {
              ...
              std::string& _val326 = this->carrier[_key325];
...
uint32_t SocialGraphService_Unfollow_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->carrier.size()));
    std::map<std::string, std::string> ::const_iterator _iter327;
    for (_iter327 = this->carrier.begin(); _iter327 != this->carrier.end(); ++_iter327)
    {
      xfer += oprot->writeString(_iter327->first);
      xfer += oprot->writeString(_iter327->second);
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
...
uint32_t SocialGraphService_FollowWithUsername_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("carrier", ::apache::thrift::protocol::T_MAP, 4);
  {
    ...
    for (_iter336 = this->carrier.begin(); _iter336 != this->carrier.end(); ++_iter336)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i351 = 0; _i351 < _size347; ++_i351)
            {
              ...
              std::string& _val353 = this->carrier[_key352];
