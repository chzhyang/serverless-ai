    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->media_data_list.resize(_size140);
            uint32_t _i144;
            for (_i144 = 0; _i144 < _size140; ++_i144)
            {
              xfer += iprot->readString(this->media_data_list[_i144]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 8:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->post_type = (PostType::type)ecast145;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i150 = 0; _i150 < _size146; ++_i150)
            {
              ...
              std::string& _val152 = this->carrier[_key151];
...
uint32_t ComposePostService_ComposePost_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("media_data_list", ::apache::thrift::protocol::T_LIST, 7);
  {
    ...
    for (_iter155 = this->media_data_list.begin(); _iter155 != this->media_data_list.end(); ++_iter155)
    {
...
uint32_t ComposePostService_ComposePost_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("media_ids", ::apache::thrift::protocol::T_LIST, 5);
  {
    ...
    for (_iter157 = (*(this->media_ids)).begin(); _iter157 != (*(this->media_ids)).end(); ++_iter157)
    {
  ...
  xfer += oprot->writeFieldBegin("media_types", ::apache::thrift::protocol::T_LIST, 6);
  {
    ...
    for (_iter158 = (*(this->media_types)).begin(); _iter158 != (*(this->media_types)).end(); ++_iter158)
    {
  ...
  xfer += oprot->writeFieldBegin("media_data_list", ::apache::thrift::protocol::T_LIST, 7);
  {
    ...
    for (_iter159 = (*(this->media_data_list)).begin(); _iter159 != (*(this->media_data_list)).end(); ++_iter159)
    {
  ...
  xfer += oprot->writeFieldBegin("carrier", ::apache::thrift::protocol::T_MAP, 9);
  {
    ...
    for (_iter160 = (*(this->carrier)).begin(); _iter160 != (*(this->carrier)).end(); ++_iter160)
    {
...
void ComposePostServiceClient::ComposePost(const int64_t req_id, const std::string& username, const int64_t user_id, const std::string& text, const std::vector<int64_t> & media_ids, const std::vector<std::string> & media_types, const std::vector<std::string> & media_data_list, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  send_ComposePost(req_id, username, user_id, text, media_ids, media_types, media_data_list, post_type, carrier);
  recv_ComposePost();
}
...
void ComposePostServiceProcessor::process_ComposePost(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ComposePost(args.req_id, args.username, args.user_id, args.text, args.media_ids, args.media_types, args.media_data_list, args.post_type, args.carrier);
...
{
  int32_t seqid = send_ComposePost(req_id, username, user_id, text, media_ids, media_types, media_data_list, post_type, carrier);
