...
void Media::__set_media_data(const std::string& val) {
  this->media_data = val;
}
...
uint32_t Media::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->media_data);
          this->__isset.media_data = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Media::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("media_data", ::apache::thrift::protocol::T_STRING, 3);
  xfer += oprot->writeString(this->media_data);
  xfer += oprot->writeFieldEnd();
...
void swap(Media &a, Media &b) {
  ...
  swap(a.media_data, b.media_data);
  swap(a.__isset, b.__isset);
}
...
void Media::printTo(std::ostream& out) const {
  ...
  out << ", " << "media_data=" << to_string(media_data);
  out << ")";
}
