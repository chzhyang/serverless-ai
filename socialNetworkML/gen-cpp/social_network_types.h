...
typedef struct _Media__isset {
  _Media__isset() : media_id(false), media_type(false), media_data(false) {}
  bool media_id :1;
  bool media_type :1;
  bool media_data :1;
} _Media__isset;
...
class Media : public virtual ::apache::thrift::TBase {
 public:
  ...
  Media() : media_id(0), media_type(), media_data() {
  }
  ...
  void __set_media_data(const std::string& val);
